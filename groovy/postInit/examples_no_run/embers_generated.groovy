...
log 'mod \'embers\' detected, running script'
...
// Mixer:
// Converts up to 3 input fluidstacks into an output fluidstack in a Mixer. If Mystical Mechanics is installed, the
// Mechanical Actuator can be used to decrease the Ember cost of a recipe.
