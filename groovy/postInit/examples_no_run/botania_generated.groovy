...
// Petal Apothecary Catalysts:
// Allows configuring items used to finalize recipes in Petal Apothecary instead of seeds. Has the same effect as adding
// them through the config file.
...
// Runic Altar Catalysts:
// Allows configuring items used to activate Runic Altar recipes instead of Livingrock. Has the same effect as adding them
...
// Runic Altar Retained Items:
// Allows configuring items that will be dropped out of the Runic Altar at the end of the recipe rather than being
// consumed. Has the same effect as adding them through the config file.
...
// Transforms any number of items put on top of a Terrestrial Agglomeration Plate into another item with a mana cost.
// Requires a specific layout of the 3x3 blocks underneath the plate, and can optionally transform them.
