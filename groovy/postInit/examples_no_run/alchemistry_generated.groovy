...
// groovyscript.wiki.alchemistry.content.title:
// groovyscript.wiki.alchemistry.content.description.

// mods.alchemistry.content.createElement(200, 'Advanced Hydrogen', 'Ah', 255, 255, 255)
// mods.alchemistry.content.createCompound(201, 'Whatever Molecule', [['advanced_hydrogen', 4],['advanced_hydrogen', 1],['oxygen', 6]])
// mods.alchemistry.content.createCompound(200, 'Advanced Hydrogen Molecule', 205, 205, 205, [['advanced_hydrogen', 1],['advanced_hydrogen', 1],['advanced_hydrogen', 1]])
...
// mods.alchemistry.evaporator.removeByInput(fluid('water'))
...
// mods.alchemistry.liquifier.removeByInput(item('alchemistry:compound:7'))
